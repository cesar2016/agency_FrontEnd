...
import { FiTrendingUp, FiDollarSign, FiCheckCircle, FiFileText, FiRefreshCw, FiEye, FiTrash2, FiX, FiLock, FiChevronDown, FiChevronRight, FiAlertTriangle } from 'react-icons/fi';
...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      {currentUser?.username === 'mesileo0905' && showPaymentAlert && createPortal(
